...
namespace Napoleon.Tests
{
    public class ConfigurationTests
    {
        ...
        public void Configuration_with_only_cluster_name_is_not_valid()
        {
            ...
            Assert.That(withCluster.CheckConfiguration, Is.False, "configuration without network information should not be valid");
        }
        ...
        public void Check_config_with_multicast_group()
        {
            ...
            Assert.That(invalidGroupAddress.CheckConfiguration, Is.False, "configuration with invalid group address should not be valid");
            ...
            Assert.That(invalidGroupPort.CheckConfiguration, Is.False, "configuration with invalid group port should not be valid");
            ...
            Assert.That(validMulticastConfig.CheckConfiguration, Is.True, "configuration with valid multicast group should be valid");
        }
    }
}